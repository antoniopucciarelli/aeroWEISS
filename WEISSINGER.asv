...
coeff_PLOT(MATRIX,PANELwing,beta,lambda,M,N,S,linspace(-10,10,100),"yes");
...
for taper = TAPERvec
    ...
    [Cl_vec,Cd_vec] = coeff_PLOT(MATRIX,PANELwing,beta,lambda,M,N,S,alpha_vec,flag);
...
[Cl_vec1,Cd_vec1,Cl_vec2,Cd_vec2] = coeff_PLOT_multi(MATRIX,PANELwing,beta,[AOA1,AOA2],[lambda1,lambda2],[M1,M2],[N1,N2],[S1,S2],linspace(-10,0,100),"yes");
...
for AOA2 = AOA2vec
    ...
    % computing Cl vs alpha 
    [Cl_vec1,Cd_vec1,Cl_vec2,Cd_vec2] = coeff_PLOT_multi(MATRIX,PANELwing,beta,[AOA1,AOA2],[lambda1,lambda2],[M1,M2],[N1,N2],[S1,S2],linspace(-10,0,100),"noplot");
